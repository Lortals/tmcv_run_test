...
/****************************************************************************
 * Gaussian Tile Intersection (Unpacked Mode Only)
 ****************************************************************************/
...
__global__ void isect_tiles(
    ...
    const uint32_t N,
    // data
    const T *__restrict__ means2d,                   // [C, N, 2]
    const int32_t *__restrict__ radii,               // [C, N]
    const T *__restrict__ depths,                    // [C, N]
